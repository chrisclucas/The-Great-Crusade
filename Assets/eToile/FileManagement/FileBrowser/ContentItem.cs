...
public class ContentItem : MonoBehaviour {
    ...
    // Set Item properties (called from outside):
    ...
    // Set itself as selected item and starts detecting double click gesture:
    ...
    // Gesture recognition to execute selection on double click:
